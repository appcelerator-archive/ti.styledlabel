...
<modules>
	<module version="0.1">ti.styledlabel</module>
</modules>
...
For example,
	...
	var my_module = require('ti.styledlabel');
	my_module.foo();
...
To create a module, create a file named ti.styledlabel.js under the assets folder.
